...
insert into products (name, description, code, price) values ('Vibrator', 'Pellentesque at nulla. Suspendisse potenti.', '445924201-X', 8.99);
...
insert into products (name, description, code, price) values ('Mini Wand Vibrator', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla.', '492662523-7', 21.99);
